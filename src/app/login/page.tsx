...
export default function LoginPage() {
  ...
  return (
    <div className="h-[calc(100vh-64px)] flex items-center justify-center bg-white dark:bg-[#1c1b22]">
      <div className="lg:min-h-[60vh] min-h-[50vh] w-full max-w-md lg:max-w-lg p-8 bg-[#e7e8e96c] rounded-lg relative shadow-md dark:bg-[#1c1917]">
        ...
        <h1 className="text-3xl font-bold text-center mb-6 text-green-600 dark:text-rose-600 mt-0 lg:mt-10">Login</h1>
        <form className="space-y-5">
          <div className="space-y-1.5 items-center">
            <Label htmlFor="emailOrUsername" className="text-sm font-medium text-gray-700 dark:text-gray-400" >
              Email or Username
            </Label>
            <Input 
              id="emailOrUsername" 
          ...
          <div className="space-y-1.5 items-center">
            <Label htmlFor="" className="text-sm font-medium text-gray-700 dark:text-gray-400">
              Password
            </Label>
            <Input 
              id="password" 
          ...
          <div className="flex justify-between items-center text-sm">
            <Link href="/forgot-password" className="text-green-600 dark:text-rose-600 hover:underline">
              Forgot Password?
            </Link>
            <Link href="/signup" className="text-green-600 dark:text-rose-600 hover:underline">
              New User? Sign up
            </Link>
          </div>
          ...
          <Button variant="outline" type="button" className="w-full border-green-500 dark:border-rose-500 text-green-600 dark:text-rose-600 hover:bg-green-50 dark:hover:bg-[#1c1b22] dark:bg-[#1c1917]">
