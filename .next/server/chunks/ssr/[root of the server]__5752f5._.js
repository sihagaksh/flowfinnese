...
;
const supabaseUrl = ("TURBOPACK compile-time value", "https://ulcfyibgyykzviypjyfu.supabase.co");
const supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVsY2Z5aWJneXlrenZpeXBqeWZ1Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzUxNDA2NTMsImV4cCI6MjA1MDcxNjY1M30.ghvtVgz4NZlhYK_YtRCDo8wbd9tMicL5kpi6S60N3UA");
...
function Signup() {
    ...
    const handleSignup = async ()=>{
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
            email,
            password
        });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__5752f5._.js.map